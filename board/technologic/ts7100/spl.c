...
#if 0
#  if 1
/* If this fails, first confirm the eim reordering, then the right
   register offsets, then the values. (2020-09-21) */
static struct mx6_mmdc_calibration ts7250v3_1g_calibration = {
	.p0_mpwldectrl0 = 0x000D0007,
	.p0_mpdgctrl0 = 0x015000150,
	.p0_mprddlctl = 0x40405054,
